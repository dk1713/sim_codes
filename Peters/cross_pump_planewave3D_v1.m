...
k1crossx = k0-2*pi/lamgrat2*cos(alphagrat2p);
k1crossy = -2*pi/lamgrat2*sin(alphagrat2p);
k1crossz = (-1)^(upw1+1)*sqrt(k0^2-k1crossx.^2-k1crossy.^2);
n1cross = [k1crossx k1crossy k1crossz]/k0
...
k2crossy = k0-2*pi/lamgrat1*cos(alphagrat1p);   % in pump 1 (true) coordinate system
