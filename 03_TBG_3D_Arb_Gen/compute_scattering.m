function [al, Ex, Ey, Ez] = compute_scattering(varargin)
...
% z=vertical but internally in this function y=vertical, z=transverse
    ...
    switch nargin
        case 11
            plotfig = varargin{11}; % check for figures
        case 10
            plotfig = 0; % check for figures
        otherwise
    ...
    kz      = varargin{9}; % K_z
    pol     = varargin{10}; % input polarisation
    ...
    % define polarisation vectors of s and p, for input (pump) and output 
    % (Bragg scattered beam):

    % define incident plane, i.e. its normal vector (normal to propagation 
    % and normal of grating)
    % ninc = ngrat x nprop
    ...
    if plotfig
        figure(30)
        plot(...
            al_prop*180/pi, nscatx,...
            al_prop*180/pi, nscaty,...
            al_prop*180/pi, nscatz)
        xlabel('propagation angle')
    ...
    if plotfig
        figure(31)
        plot(...
            al_prop*180/pi, ninpx,...
            al_prop*180/pi, ninpy,...
            al_prop*180/pi, ninpz)
        xlabel('propagation angle')
        ylabel('x,y,z projections')
        legend('x component','y component','z component')
        ...
        figure(32)
        plot(...
            al_prop*180/pi, ninsx,...
            al_prop*180/pi, ninsy,...
            al_prop*180/pi, ninsz)
        xlabel('propagation angle')
        ylabel('x,y,z projections')
        legend('x component','y component','z component')
        ...
        figure(33)
        plot(...
            al_prop*180/pi, noutpx,...
            al_prop*180/pi, noutpy,...
            al_prop*180/pi, noutpz)
        xlabel('propagation angle')
        ylabel('x,y,z projections')
        legend('x component','y component','z component')
        ...
        figure(34)
        plot(...
            al_prop*180/pi, noutsx,...
            al_prop*180/pi, noutsy,...
            al_prop*180/pi, noutsz)
        xlabel('propagation angle')
        ylabel('x,y,z projections')
        legend('x component','y component','z component')
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    Es3 = -1 ./ (2*cos(al_inc).^2) .*w./sin(2*theta) .*dng./neff ...
        .*pi^1.5 ./Lambda .*exp(-(w./(2*sin(2*theta))).^2 ...
        .*(2*kpumpnormal.*cos(theta).^2 - 2*pi./Lambda).^2);
    ...
    elseif pol == 2     % poump polarization vertical
        ...
        fprintf('wrong polarisation option input');
        return;
    end
end